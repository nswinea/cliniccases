...
$(document).ready(function() {
    ...
    $('#trends_button').click(function() {
        ...
        //See http://www.jqplot.com/deploy/dist/examples/bar-charts.html
        //and
        ...
        target.load('lib/php/data/home_trends_load.php', function() {
          ...
          var plot3 = $.jqplot('home_panel', [line1], {
            title: 'Most Active in Group During Last Week',
            seriesDefaults: {
            ...
            series:[
             {pointLabels:{
                show: true,
                labels:['Adrienne Wheeler', 'Nick Zotti', 'Marc Florman', 'Shannon Jung', 'John Norris']
              }}],
            axes: {
